...
public class Context extends HashMap<String, Object> {
    ...
    public Context(Map<String, Object> raw) {
        super(raw);
    }

    public Context(String type, Context defaults, Map<String, Object> raw) {
        super(raw);
        this.type = type;
    ...
    public int getInt(String... keys) {
        ...
        if (result != null) {
            ...
            throw new Exception("no default int value found for keys" + Arrays.asList(keys) + " in type[" + type + "]");
        }
    }
    ...
    public int[] getIntArray(String... keys) {
        ...
        if (result == null) {
            throw new Exception("no default int array found for keys" + Arrays.asList(keys) + " in type[" + type + "]");
        }
        return result;
    }
    ...
    public float getFloat(String... keys) {
        ...
        if (result != null) {
            ...
            throw new Exception("no default float value found for keys" + Arrays.asList(keys) + " in type[" + type
                    + "]");
        }
    }
    ...
    public String getString(String... keys) {
        ...
        for (String key : keys) {
            if (idx > 1) {
                ...
                if (intermedia == null) {
                    throw new Exception("configruation[" + key + "] is missing");
                }
            } else {
                try {
        ...
        if (result != null) {
            ...
            throw new Exception("no default string value found for keys" + Arrays.asList(keys) + " in type[" + type
                    + "]");
        }
    }
    ...
    @SuppressWarnings("unchecked")
    public Context getSub(String type, String... keys) {
        Map<String, Object> intermedia = this;
        if (keys == null) {
        ...
        return new Context(type, defaults, intermedia);
    }
}
