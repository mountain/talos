...
public class Recommendation implements VectorSetListener {
    ...
    public Recommendation(VectorSet source, VectorSet target, CosineScore scoring) {
        this(source, target, scoring, 20);
    }

    public Recommendation(VectorSet source, VectorSet target, CosineScore scoring, int limits) {
        this.source = source;
        this.target = target;
        this.limit = limits;
    ...
    public void clean() {
        ...
        while (iter.hasNext()) {
            ...
            if (this.source.contains(srcId)) {
                ...
                Sorter sorter = new Sorter(this, srcId, oldSorter.limits);
    ...
    public Sorter create(long srcVecId) {
        ...
        if (sorter == null) {
            sorter = new Sorter(this, srcVecId, this.limit);
