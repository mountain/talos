...
public class CnNum {
    ...
    /*
     * public static void main(String[] args) { Dictionary.isCNNumeric('一');
     * int val = 0; long s = System.nanoTime(); //val =
     * cnNumericToArabic("三亿二千零六万七千五百六", true); //val =
     * cnNumericToArabic("一九九八", true); long e = System.nanoTime();
