...
public class DicConverter {
     ...
     * @throws IOException
     */
    public static boolean convert(File srcFile, File dstFile, int _cvt) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        if (cvt != SIMPLIFIED_TO_TRADITIONAL && cvt != TRADITIONAL_TO_SIMPLIFIED) {
        ...
        System.out.println("type: Jcseg词库" + ((cvt == SIMPLIFIED_TO_TRADITIONAL) ? "简体转繁体" : "繁体转简体"));
        ...
        try {
            ...
            for (int j = 0; j < files.length; j++) {
                ...
                if (convert(files[j], new File(dstDir.getAbsolutePath() + "/" + files[j].getName()), cvt)) {
